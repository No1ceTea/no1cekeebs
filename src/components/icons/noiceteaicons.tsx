...
export default function NoiceteaIcon() {
  return (
    <svg className="w-5 inline-block transition-transform group-hover:rotate-[20deg]" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 33.9 42.3">
